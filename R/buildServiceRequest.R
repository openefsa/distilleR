...
#' 
#' @param distillerToken `character` (string, optional). The personal access
#'   token generated by the authentication request.
#' 
...
.buildServiceRequest <- function(
  ...
  if (!is.null(distillerToken)) { assert_string(distillerToken) }
